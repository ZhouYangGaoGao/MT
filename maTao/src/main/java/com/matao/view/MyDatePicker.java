...
public class MyDatePicker extends LinearLayout {
	...
	private void init(Context context) {
		...
		LinearLayout.LayoutParams yearParams = new LayoutParams(
		...
		LinearLayout.LayoutParams monthParams = new LayoutParams(
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		...
		LinearLayout.LayoutParams dayParams = new LayoutParams(
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT,
				android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
		dayParams.weight = 1;
	...
	private OnWheelChangedListener onYearsChangedListener = new OnWheelChangedListener() {
		...
		public void onChanged(WheelView hours, int oldValue, int newValue) {
			Log.e("时间", calendar.get(Calendar.YEAR) + "年");
			calendar.set(Calendar.YEAR,
					Calendar.getInstance().get(Calendar.YEAR) - 11 + newValue);
