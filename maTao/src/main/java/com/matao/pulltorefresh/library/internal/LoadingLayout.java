...
import com.matao.pulltorefresh.library.ILoadingLayout;
import com.matao.pulltorefresh.library.PullToRefreshBase.Mode;
import com.matao.pulltorefresh.library.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements
	...
	private void setTextColor(ColorStateList color) {
		if (null != mHeaderText) {
			mHeaderText
					.setTextColor(getResources().getColor(R.color.gray_word));
		}
		if (null != mSubHeaderText) {
